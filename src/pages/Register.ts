        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form id="registerForm" class="space-y-6">
                ...
                <div class="flex justify-between gap-4">
                    ...
                    <button type="submit" class="flex w-full justify-center rounded-md bg-primary px-3 py-1.5 font-display font-semibold text-bg capitalize hover:bg-secondary hover:cursor-pointer">register</button>
                </div>
            </form>
        </div>
      </div>
